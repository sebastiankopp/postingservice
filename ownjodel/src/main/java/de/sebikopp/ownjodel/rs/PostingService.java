...
public class PostingService {
	...
	@POST
	@Path("")
	public Response publishNewPost(JsonObject submittedPost){		
	...
	@POST
	@Path("{father}")
	public Response createSubpost(String json, @PathParam("father") String fatherId){
	...
	@GET
	@Path("")
	public Response seeAllPosts(){
		return Response.ok(read.getAllPosts()).build();
	}
	@GET
	@Path("{postid}")
	public Response seePostById(@PathParam("postid") String postid){
