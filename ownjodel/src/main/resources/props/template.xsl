		...
		<fo:root>
			...
			<fo:page-sequence master-reference="A4-portrait">
				<fo:flow flow-name="xsl-region-body">
					<fo:block font-weight="bold" font-size="18pt" role="h1" space-after="3mm">
					...
					<fo:block font-size="14pt" role="h2" space-before="5mm" space-after="2mm" font-weight="bold">Votes</fo:block>
					<fo:block>
